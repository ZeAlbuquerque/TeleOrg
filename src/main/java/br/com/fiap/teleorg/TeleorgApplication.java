...
public class TeleorgApplication {
    ...
    public CommandLineRunner init(@Autowired HospitalRepository hospitalRepository,
        ...
        return args -> {
            ...
            pacienteRepository.save(new Paciente("Boaventura Rebelo", TipoSanguineo.ABNegativo, cal, "59662771093", false, hospitalService.findById(1)));

            cal.setTime(sdf.parse("25/12/1988"));

            pacienteRepository.save(new Paciente("Ferdinando Moreira", TipoSanguineo.ABPositivo, cal, "16587957099", false, hospitalService.findById(1)));

            cal.setTime(sdf.parse("30/04/1973"));

            pacienteRepository.save(new Paciente("Levi Fontoura", TipoSanguineo.ANegativo, cal, "12731085070", false, hospitalService.findById(2)));

            cal.setTime(sdf.parse("05/10/1978"));

            pacienteRepository.save(new Paciente("Mariano França", TipoSanguineo.APositivo, cal, "16315091016", false, hospitalService.findById(2)));

            cal.setTime(sdf.parse("22/03/1969"));

            pacienteRepository.save(new Paciente("Nazaré Damasceno", TipoSanguineo.BNegativo, cal, "61473178061", false, hospitalService.findById(1)));

            cal.setTime(sdf.parse("12/09/1994"));

            pacienteRepository.save(new Paciente("Sebastião Ferreyra", TipoSanguineo.BPositivo, cal, "66170246057", false, hospitalService.findById(1)));

            cal.setTime(sdf.parse("25/12/1988"));

            pacienteRepository.save(new Paciente("Ubajara Caeira", TipoSanguineo.ONegativo, cal, "00941221059", false, hospitalService.findById(2)));

            cal.setTime(sdf.parse("30/04/1973"));

            pacienteRepository.save(new Paciente("Úrsula Valente", TipoSanguineo.OPositivo, cal, "11558685014", false, hospitalService.findById(2)));
